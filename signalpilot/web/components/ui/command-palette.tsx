...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    { id: "nav-notebooks", label: "notebooks", description: "analysis notebooks", shortcut: "^5", action: () => router.push("/notebooks"), icon: <IconNav />, category: "navigate" },
    { id: "nav-sandboxes", label: "sandboxes", description: "gvisor sandboxes", shortcut: "^6", action: () => router.push("/sandboxes"), icon: <IconNav />, category: "navigate" },
    { id: "nav-connections", label: "connections", description: "database connections", shortcut: "^7", action: () => router.push("/connections"), icon: <IconNav />, category: "navigate" },
    { id: "nav-health", label: "health monitoring", description: "connection health and latency", shortcut: "^8", action: () => router.push("/health"), icon: <IconNav />, category: "navigate" },
    { id: "nav-audit", label: "audit log", description: "compliance audit trail", shortcut: "^9", action: () => router.push("/audit"), icon: <IconNav />, category: "navigate" },
